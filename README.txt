...
=====================
Introduction to mrst
=====================

mrst boasts a clean HTML5 structure with extensible CSS classes and IDs for
...
mrst's goal is to provide themers the building blocks needed to get their
designs up and running quickly and simply.

mrst is perfect if you want a simple, smart, and flexible theme starter.
...
mrst utilizes SASS for adaptive grids and layouts and general structure of the
...
mrst is meant to be YOUR theme. Follow one of the two methods below and you can
rename 'mrst' to another name like 'mytheme'. You're also welcome to keep
'mrst'.

1. DRUSH: The provided drush install script will duplicate the mrst theme
   folder and rename all appropriate files and content to the new theme name you
   provide.

  - Download and enable the mrst theme: $ drush en mrst
  - Set the theme as default $ drush config-set system.theme default mrst
    or copy the includes/mrst.drush.inc into your .drush folder.
  - Run the provided drush install script: $ drush mrst-install
  ...
  - At this time, you can uninstall mrst: $drush pmu mrst
...
2. MANUAL: To manually change the name of the theme follow these steps BEFORE
  ...
  - Rename mrst.info.yml to mytheme.info.yml
  - edit mrst.info.yml and change the name, description, project (can be
    deleted), and change all other instances of 'mrst' to 'mytheme'
  - Rename mrst.libraries.yml to mytheme.libraries.yml
  - Rename mrst.theme to mytheme.theme
  - in mrst.theme, change each instance of 'mrst' to 'mytheme'
  - Rename config/schema/mrst.schema.yml to mytheme.schema.yml
  - Rename each file in config/install from block.block.mrst_tools.yml (for
    example) to block.block.mytheme_tools.yml
  - Every file in config/install, change each instance of 'mrst' to
    'mytheme'
  - In js/source/scripts.js, change each instance of 'mrst' to 'mytheme'
  - In theme-settings.php, change each instance of 'mrst' to 'mytheme'
  - In templates/html.html.twig, change each instance of 'mrst' to 'mytheme'
  - In templates/menu-local-tasks.html.twig, change each instance of 'mrst' to
    'mytheme'
  - In templates/status-messages.html.twig, change each instance of 'mrst' to
    'mytheme'

  When renaming, remember the following:
  - Do not simply replace every instance of 'mrst' in every file in the theme.
    Most of mrst's dependencies use the word 'mrst' somewhere and renaming
    these instances will cause mrst to break in unpredictable ways.
  ...
  - If you don't bother renaming mrst in the above locations, be advised that
    you will run into conflicts with other versions of mrst on your site. If
    your site uses more than one theme based on mrst, make sure at least one of
    the themes has been renamed properly!


============================
How to compile SASS in mrst
============================

To use SASS and automatically compile it within your theme, please refer to "How
to Use Grunt with mrst" in the documentation below.
...
- build/scripts.js & source/scripts.js
  ...
  folder. See comments in mrst.libraries.yml file to enable the starter
  scripts.js file.
...
The layout used in mrst is fairly similar to the Holy Grail method. It has been
...
This is how the page template is buit in mrst, and it works in fluid and fixed
layout. Refer to the notes in layout.sass to see how to modify the layout.


===========================
How to Use Grunt with mrst
===========================
...
Once Node.JS is installed, go to the root folder of mrst and install your Grunt
packages:
...
Once installed, cd to the root folder of mrst and run Grunt via the command
line:
...
Once you start using mrst, you will massively change it until you reach the
point where it has nothing to do with mrst anymore. Unlike Zen, mrst is not
...
version of mrst comes out. Always see mrst as a STARTER, and as soon as you
start using it, it is not mrst anymore, but your own theme.

If you didn't rename your theme, but you don't want to be notified when mrst
has a new version by the update module, simply delete "project = "mrst" in
mrst.info.yml.
...
Thanks for using mrst, and remember to use the issue queue in drupal.org for
any questions or bug reports:

http://drupal.org/project/issues/mrst
